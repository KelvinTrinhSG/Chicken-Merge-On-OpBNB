...
**Account Abstraction & Smart Wallet on opBNB:**
...
## How we built it
We use account abstraction and smart wallet technology on opBNB combined with Unity engine to build Game Chicken Merge.
